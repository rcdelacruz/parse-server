...
ENTRYPOINT ["npm", "start", "--", "--appId",  "myappid", "--masterKey", "mymasterkey",  "--serverURL", "http://10.129.1.222/parse", "--databaseURI", "mongodb://mong:password@172.30.54.3:27017/sampledb"]
