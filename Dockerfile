...
ENTRYPOINT ["npm", "start", "--", "--appId",  "myappid", "--masterKey", "mymasterkey",  "--serverURL", "http://10.129.1.222/parse", "--databaseURI", "mongodb://mongouser:password@172.30.122.102:27017/sampledb"]
