...
ENTRYPOINT ["npm", "start", "--", "--appId",  "myAppId", "--masterKey", "myMasterKey",  "--serverURL", "https://parse-server.stratpoint.io/parse", "--databaseURI", "mongodb://mongouser:password@172.30.43.11:27017/sampledb"]
